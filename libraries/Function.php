<?php 
    ...
    **/
    ...
    /**
    * tao slug -- chuyển kiểu chữ - có dấu thành ko dấu
    **/
    ...
    //clean mấy cái ký tự đặc biệt khi nhập vào
    ...
    //Đổi tên project -- Khi qua máy khác mà có tên project khác thì đổi 1 lần là dùng được, không cần phải đổi cả bài
    function base_url()
    {
    ...
    /**
     *  redirect về các trang -- Đổ về dữ liệu về trang cần dùng
     */
    ...
    /**
     * Lấy tất cả các sản phẩm mà có id = id truyền vào
     */
    ...
    //Thêm dấu chấm, dấu phẩy cho giá cả các số
    function formatPrice($number)
    {
        $number = intval($number);
        return $number = number_format($number, 0, ',', '.')."đ"; //0 là sau dấu phẩy ko lấy thêm số thập phân nào nữa
    }

    //Giảm giá bao nhiêu % (sale)
