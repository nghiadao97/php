    ...
    */
    class Database
    {
        ...
        */
        ...
        //Kiểm tra xem danh mục đã tồn tại sản phẩm hay chưa, nếu chưa thì được xóa - ko thì ko được xóa
        ...
        //lấy hết tất cả dữ liệu của bảng chuyền vào
        ...
        public  function fetchJones($table,$sql,$total = 1,$page,$row ,$pagi = true ) //$total = 1 là tổng số bảng ghi
        {
