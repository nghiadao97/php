...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $updatecart.click(function(e){
            ...
            $soluong = $(this).parents("tr").find(".soluong").val(); //parents("tr") là cái thẻ bao bọc toàn bộ cái updatecart; find("soluong").val(): tìm đến nơi có name="soluong" lấy giá trị ra
            //console.log($soluong);
            $key = $(this).attr("data-key");
            $.ajax({
                url: 'cap-nhat-gio-hang.php',   
                type: 'GET',
                data: {'soluong': $soluong, 'key':$key},
