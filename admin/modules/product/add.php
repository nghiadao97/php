                ...
                <div class="col-md-6">
                    <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data"> <!-- Muốn upload được ảnh cần có enctype="multipart/form-data" -->
                       ...
                       <div class="form-group">
                          ...
                          <input name="name" type="text" id="inputEmail3" class="form-control" placeholder="Tên danh mục" >
                          <!-- Kiểm tra rồi báo cho người dùng biết lỗi đó -->
                       ...
                       <div class="form-group">
                          ...
                          <input name="price" type="number" id="inputEmail3" class="form-control" placeholder="9.000.000" >
                          <!-- Kiểm tra rồi báo cho người dùng biết lỗi đó -->
                       ...
                       <div class="form-group">
                          ...
                          <input name="number" type="number" id="inputEmail3" class="form-control" placeholder="100" >
                          <!-- Kiểm tra rồi báo cho người dùng biết lỗi đó -->
                       ...
                       <div class="form-group">
                          <label for="exampleInputEmail1">Giảm giá</label>
                            <input name="sale" type="number" id="inputEmail3" class="form-control" placeholder="10 %" value="">
